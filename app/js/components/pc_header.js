...
class PCHeader extends React.Component{
  ...
  handleSubmit(e){
    ...
    fetch("http://newsapi.gugujiankong.com/Handler.ashx?action="
          ...
          +"&password="+formData.password+"&r_userName="+formData.r_userName
          +"&r_password="+formData.r_password+"&r_confirmPassword="+formData.r_confirmPassword,
        myFetchOptions)
